...
This project provides utilities to work with Snapmaker U1 firmware images. It enables downloading official firmware, extracting the contents, creating custom firmware builds, and enabling debug features.

## Features

- Download official Snapmaker U1 firmware
- Extract firmware images (SquashFS rootfs)
- Create custom firmware with modifications
- Enable debug and misc partition access
- Rockchip RK2918 firmware image tools
...
### upfile
Firmware unpacking utility for Rockchip update files.
